...
class SiteController extends Controller
{
    ...
    public function favicon(SiteContent $content): Response
    {
        ...
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><rect width="64" height="64" rx="12" fill="#09090b"/>'
            .'<text x="32" y="42" font-family="sans-serif" font-size="30" font-weight="700" text-anchor="middle" fill="#fbbf24">'
            .$initials.'</text></svg>';
